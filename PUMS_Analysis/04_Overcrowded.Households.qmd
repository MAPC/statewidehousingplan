...
#This assigns a PUMA to the RPA with which it has the most areal overlap.
...
write.csv(
  ...
  paste0(output_path, "04_Overcrowding/overcrowding.MULTG.SF.FAMILY.PPB.RPAlevel.csv"),
  row.names = FALSE
)

#===============================================================================
# 4.1.4 Overcrowding by RPA and Multigenerational Households (Census Definitions) and Number of Subfamilies
