...
for (yr in c(2020,2030,2035,2040,2045,2050)){
  ...
  uw <- hh %>% 
    ...
    mutate(own20_35 = own_2035 - own_2020,
           own35_50 = own_2050 - own_2035,
           rent20_35 = rent_2035 - rent_2020,
           rent35_50 = rent_2050 - rent_2035) %>% 
    left_join(vax, by=c('mpo'='rpa_acr')) %>% 
    setDT()


# 2020 to 2035
uw[, own_vacated20_35 := min(0, own20_35), mpo]
uw[, rent_vacated20_35 := min(0, rent20_35), mpo]
uw[, own_growth_vac20_35 := own20_35 * own_vac_rate_total, mpo]
uw[, rent_growth_vac20_35 := rent20_35 * rent_vac_rate_total, mpo]
uw[, own_units_needed_2035 := own_2035 * (1 + own_vac_rate_total)]
uw[, own_units_needed_2050 := own_2050 * (1 + own_vac_rate_total)]
uw[, rent_units_needed_2035 := rent_2035 * (1 + rent_vac_rate_total)]
uw[, rent_units_needed_2050 := rent_2050 * (1 + rent_vac_rate_total)]

uw[,new_owner_units_2035 := own_units_needed_2035 - t]
