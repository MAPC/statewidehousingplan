...
# Municipal ---------------------------------------------------------------
hmda_mortgage_denials_by_race_150k_m <- hmda_mu_func_1821(hmda_yr = hmda_yr)


## 7. run aggregation function
# Aggregations ---------

hmda_mortgage_denials_by_race_150k_m_aggr <-
  # Subregion # id = 3 # nm = 4
  bind_rows(
...
## 10. export to csv
write_csv(df, paste0(exp_path,"/",hmda_yr,"/hmda_mortgage_denials_by_race_150k_m.csv"))
