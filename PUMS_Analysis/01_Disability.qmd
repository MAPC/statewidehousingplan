...
ambulatory_percentage_hhld <- (ambulatory_total_households / total_weighted_households) * 100 #need a different denominator, 5 and up
...
self_care_percentage_hhld <- (self_care_total_households / total_weighted_households) * 100  #need a different denominator 
...
independent_living_percentage_hhld <- (independent_living_total_households / total_weighted_households) * 100 #need a different denominator 
