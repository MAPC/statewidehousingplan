...
```{r}
#1) Calculate the number of people with a disability - unsure about GQ variable
...
12% have some type of disability statewide. 
...
22% of households in the state have someone with a disability 
