...
hdsp.r_scenario2 <- purrr::reduce(
  ...
  dplyr::rename(
    freq.split.25 = freq.split.x,
    freq.split.30 = freq.split.y,
    freq.split.35 = freq.split.x.x,
    freq.split.40 = freq.split.y.y,
    freq.split.45 = freq.split.x.x.x,
    freq.split.50 = freq.split.y.y.y,
  )
