...
```{r}
#Age of housing stock for households with disability - YRBLT - note this is the only variable for vacant units, do we want to include vacant units here? This currently includes occupied units because it's based on person level disability data - meaning vacant units do not have any members with a disability because they have 0 members. 
