...
people_design_dis <- svydesign(ids = ~1,           #No clustering
                              weights = ~PWGTP,    #Apply household weights
...
Note that for cognitive difficulty, ambulatory difficulty, and self-care difficulty, children under 5 are not included in these measures.
