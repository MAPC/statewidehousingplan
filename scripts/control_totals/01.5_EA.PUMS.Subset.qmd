...
write.csv(
  full_sample.pums,
  paste0("C:/Project_Work/Local_Data/Housing/SWHP/Scenarios/Scenario_4/full.shelter.pums.sample_OCPCrun.1.csv"),
  row.names = FALSE
)
...
write.csv(
  ...
  paste0("C:/Project_Work/Local_Data/Housing/SWHP/Scenarios/Scenario_4/full.shelter.pums.diagnostic_OCPCrun.1.csv"),
  row.names = FALSE
)
