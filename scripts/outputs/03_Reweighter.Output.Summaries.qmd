...
#3.0 Univariate Output Tables for Statewide Housing Plan Deliverables 
...
write.csv(
  tbl.4,
  paste0(output_path,"/output.tbl_Households.by.NumberOfChildren.csv"),
  row.names = FALSE
)
...
write.csv(
  tbl.5,
  paste0(output_path,"/output.tbl_Households.by.HHsize.csv"),
  row.names = FALSE
)
...
write.csv(
  tbl.6,
  paste0(output_path,"/output.tbl_Households.by.Tenure.csv"),
  row.names = FALSE
)
...
write.csv(
  tbl.7,
  paste0(output_path,"/output.tbl_Households.by.NumberOfWorkers.csv"),
  row.names = FALSE
)
```
# 4.0 Mutlivariate Output Tables for UrbanSim
...
# 5.0 Multivariate Output Tables for Statewide Housing Plan
```{r}
```
