...
write.csv(
  test,
  "C:/Project_Work/Local_Data/Housing/SWHP/Scenarios/Scenario_4/shelter.hh_rpa.csv",
  row.names = FALSE
)
...
tmp.pums <- pums_EA |> filter(rpa_acr = i)
sample.pums <- slice_sample(tmp.pums, n = 1, replace = TRUE)
...
pop.total <- NULL
hh.total <- NULL
child_0004.total <- NULL
child_0509.total <- NULL
child_1014.total <- NULL
child_1517.total <- NULL
