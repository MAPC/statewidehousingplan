...
# 3.3 Calculate the percentage of the group quarters population living in Univerity/College Housing
...
#6.0 - Load and process PUMS Data #6.1 - Create PUMA to RPA/MPO Crosswalk for 2010 PUMAs
...
# 7.2 Create Headship rates for ACS 2017-2021 PUMS
...
```{r}
#Set list of decades to iterate through projections data.
...
for (i in years) {
  ...
  write.csv(
    target.file,
    paste0(output_path, "hhtype.MAPC101.targetfile.",i,".csv"),
    row.names = FALSE
  )
...
for (i in years) {
  ...
  write.csv(
    target.file,
    paste0(output_path, "hhtype.MAPC97.targetfile.",i,".csv"),
    row.names = FALSE
  )
