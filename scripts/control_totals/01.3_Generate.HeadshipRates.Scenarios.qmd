...
for (i in years) {
  ...
  if(i == 2020 | i == 2025){
    ...
    fwrite(done_pums, paste0(rwt_path,'PUMS_data/PUMS2021_Scenario_2_',i,'.csv'))
...
write.csv(
  hdsp.r_scenario2,
  paste0(rwt_path,"Headship_rates/hdsp.r.1721_household.split.paced.csv"),
  row.names = FALSE
)
...
write.csv(
  ten.r_scenario2,
  paste0(rwt_path,"Headship_rates/ten.r.1721_household.split.paced.csv"),
  row.names = FALSE
)
```
