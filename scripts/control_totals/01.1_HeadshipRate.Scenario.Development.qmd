...
# 3.2 Reorder Persons in Households to be Split
```{r}
...
# 3.3 Redefine SPORDER and Relationship Variables
```{r}
...
# 3.4 Re-create households variables for split households
```{r}
pums_data.adj <- pums_data.adj |> 
  mutate(
    # Counts as Worker
...
# 3.5 QA/QC - Check Split Households are Equal to The Number of Households We Expect to Be Split
```{r}
#===============================================================================
# Analyze Subset #1
...
# 6.0 Compare Headship Rates to 
```{r}
# Load in spreadsheet with all previously calculated headship rates.
hdsp.r <- read.csv(paste0(rwt_path,"Headship_rates/headship_rate_comparison.csv"))
