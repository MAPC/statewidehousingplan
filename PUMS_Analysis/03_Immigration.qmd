...
####Assuming that the first person in each hhld is the head of hhld - can also use SPORDER == 1 to do this
...
#Export age of hhlder by nativity table
 write.xlsx(list('Age of householder by nativity' = householder_age_foreign_born), 
...
#Export race and ethnicity tables 
 write.xlsx(list('Race of householder by nativity' = householder_race_foreign_born, 
                 'Ethnicity of householder by nativity' = householder_hisp_foreign_born), 
