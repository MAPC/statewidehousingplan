...
output_path <- paste0(base, "Housing/StatewideHousingPlan/04_Analysis/Data/Final_Outputs/", scen, "/UPDATE_w_shelter2/CKG/")
...
rwt.pums.df.join_Scenario_3_shelt <- bind_rows(rwt.pums.df.join_Scenario_3, shelter.pums_cleaned.year) |> mutate(
