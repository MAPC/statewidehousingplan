...
rwt.pums.df.join_Scenario_3 <- bind_rows(rwt.pums.df.join_Scenario_3, shelter.pums_cleaned.year)
```
...
#===============================================================================
# Creates a reference table for the total number of households in each year to compare to subsequent tables as a QA check.
tbl.0 <- rwt.pums.df.join_Scenario_4 |> 
  filter(TYPEHUGQ == 1 & SPORDER == 1) |>
  group_by(
    year
  ) |> 
...
#===============================================================================
# .3 Household Type
tbl.3 <- rwt.pums.df.join_Scenario_2  |> 
  filter(TYPEHUGQ == 1 & SPORDER == 1) |> 
  group_by(
    rpa_acr,
    year,
...
tbl.5 <- rwt.pums.df.join_Scenario_2  |>
  filter(TYPEHUGQ == 1 & SPORDER == 1) |>  
  group_by(
    rpa_acr,
    year,
...
#===============================================================================
# .6 Size of Household
tbl.6 <- rwt.pums.df.join_Scenario_2  |> 
  filter(TYPEHUGQ == 1 & SPORDER == 1) |> 
  group_by(
    rpa_acr,
    year,
...
#===============================================================================
# .7 Tenure
tbl.7 <- rwt.pums.df.join_Scenario_2  |> 
  filter(TYPEHUGQ == 1 & SPORDER == 1) |> 
  group_by(
    rpa_acr,
    year,
...
tbl.8 <- rwt.pums.df.join_Scenario_4  |> 
  filter(TYPEHUGQ == 1 & SPORDER == 1) |> 
  group_by(
    rpa_acr,
    year,
...
tbl.9 <- rwt.pums.df.join_Scenario_4  |> 
  ...
  summarise(
    avg_workers = round(mean(Worker_Total), 2)
  ) |> 
  ungroup()
...
full.crosstab <- rwt.pums.df.join_Scenario_4  |> 
  filter(TYPEHUGQ == 1 & SPORDER == 1) |>
  group_by(
    rpa_acr,
    year,
