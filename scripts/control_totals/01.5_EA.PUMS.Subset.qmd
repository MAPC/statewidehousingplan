...
for (i in c("BRPC")) {
  ...
  repeat {
    ...
    for (j in agegroup.list) {
      ...
      sample.pums <- bind_rows(sample.pums.1, sample.pums.2, sample.pums.3)
...
#   write.csv(
#     partial_sample.pums,
#     paste0("C:/Project_Work/Local_Data/Housing/SWHP/Scenarios/Scenario_4/partial_shelter.pums_",i,".csv"),
#     row.names = FALSE
#   )
# 
}

(pop.target - pop.total) < round(pop.target*0.1, 0) |
