...
write.csv(
  tbl.1,
  paste0(output_path, "q7.NP.HHSize.csv"),
  row.names = FALSE
)
...
write.csv(
  tbl.2,
  paste0(output_path, "q7.ESR.HHWorkers.csv"),
  row.names = FALSE
)
...
write.csv(
  tbl.3,
  paste0(output_path, "q7.RETP.Retirees.csv"),
  row.names = FALSE
)
...
write.csv(
  tbl.4,
  paste0(output_path, "q7.PAP.PublicAssistance.csv"),
  row.names = FALSE
)
#===============================================================================
...
write.csv(
  tbl.5,
  paste0(output_path, "q7.FS.SNAP.csv"),
  row.names = FALSE
)
...
write.csv(
  tbl.6,
  paste0(output_path, "q7.HINS4.Medicaid.csv"),
  row.names = FALSE
)
