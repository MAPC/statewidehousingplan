...
```{r}
# Generating headship rates by RPA, 5-year Age Group, and Household Type for the ACS 2017-2022 PUMS
...
if (scen == "Scenario_1"){ # Scenario 1
  ...
  hdsp.r_read(scenario = scen, file = "headship.rates.comparison_2000.hsr_to_1721.household.split.hsr.csv") |> 
    select(
      rpa_acr,
      ageCAT6,
      var,
