...
xw <- fread(paste0(output_path, 'PUMA10_RPA_crosswalk.csv')) |> 
  mutate(
...
write.csv(
  ...
  pums_data <- fread(paste0(rwt_path, '/PUMS_data/PUMS', vintage, '.Split',yr,'_formatted.csv'))
...
if (scen == "Scenario_1"){ # Scenario 1
  ...
  hdsp.r <- fread(paste0(rwt_path,"Headship_rates/hdsp.r.1721_household.split.paced.csv")) |> 
    pivot_longer(cols=starts_with('freq'),names_to='year',names_prefix='freq.split.') |> 
