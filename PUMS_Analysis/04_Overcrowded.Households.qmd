...
puma.ami_table <- get_mapc_database(db.table_name = "hous_section8_income_limits_by_year_m",
                               year = 2021,
                               vars = "*") |>
  mutate(
    #100% AMI
  ...
  # Pull AMI Table for 2021
rpa.ami_table <- get_mapc_database(db.table_name = "hous_section8_income_limits_by_year_m",
                               year = 2021,
                               vars = "*") |>
  mutate(
    #100% AMI
