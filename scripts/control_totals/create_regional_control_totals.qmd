...
write.csv(
  ...
  paste0(output_path,"pct_pop.in.hhds.MAPC101_by.RPA.Sex.ageCAT6.csv"),
  row.names = FALSE
)
...
write.csv(
  ...
  paste0(output_path,"pct_pop.in.hhds.MAPC97_by.MPO.Sex.ageCAT6.csv"),
  row.names = FALSE
)
...
write.csv(
  hhpop_baseline,
  paste0(output_path,"hhpop_baseline.1722.csv"), 
  row.names = FALSE
)
...
write.csv(
  hhtype_baseline,
  paste0(output_path,"hhtype_baseline.1722.csv"),
  row.names = FALSE
)
...
write.csv(
  lf_baseline,
  paste0(output_path,"lf_baseline.1722.csv"),
  row.names = FALSE
)
...
# Create Reweighter Template Files for Household Projections by RPA and Household Type
