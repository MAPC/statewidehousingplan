...
pums_data.adj <- pums_data |> 
  mutate(
    SERIALNO.adj = case_when(
      ...
      SFN == 1 & subset.flag.2 == 1 ~ paste0(SERIALNO,".1.sf1.adj"),
      SFN == 2 & subset.flag.2 == 1 ~ paste0(SERIALNO,".1.sf2.adj"),
      SFN == 3 & subset.flag.2 == 1 ~ paste0(SERIALNO,".1.sf3.adj"),
      SFN >= 4 & subset.flag.2 == 1 ~ paste0(SERIALNO,".1.sf4.adj"),
