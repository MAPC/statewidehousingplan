...
hhd_control <- fread(paste0(dir,'Output_Files/MAPC_Control_HHds_Projections2050_MB_97to101_v03.23.23.csv'))
...
hhd_control[,mapc:=NULL][,subregion_code:=NULL]
...
write.csv(hhd_control_update,
          paste0(dir,"Output_Files/MAPC_Control_HHds_Projections2050_MB_97to101_v03.23.23_one_year_offset.csv"),
          row.names = FALSE)
