...
variable_list <- c('RT', 'PUMA', 'ADJHSG','ADJINC','NP','TYPEHUGQ','HHLDRAGEP',
                   'HHLDRRAC1P','HHLDRHISP', 'HHT', 'HHT2', 'HINCP','LNGI', 'NR', 'PARTNER', 'PSF','R18',
                   'AGEP','RELSHIPP','RAC1P','OC','TEN', "SEX", "PINCP", "ESR", 'HISP', 'WKHP', 'HHLANP')
