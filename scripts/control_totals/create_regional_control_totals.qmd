...
# Setup - Define helper functions, set knitr path, load necessary packages, set muni data keys
...
#Load Decnnial Census data for 2010
...
rm(pa.labels, pa.values, pa.vars, vars2010, vars2020)
gc()
```
